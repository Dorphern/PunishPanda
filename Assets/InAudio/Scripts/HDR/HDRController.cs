...
//    public InAudio.ScalingType ScaleInRelationTo = InAudio.ScalingType.EnviromentLoudness;
...
//    /// </summary>
//    /// <returns></returns>
//    public List<InAudio.AudioTuple> RawAudioSourceList()
//    {
//        return AudioSources;
//    }
...
//    {
//        AudioSources.Add(new InAudio.AudioTuple(source));
//    }
...
//    private List<InAudio.AudioTuple> AudioSources = new List<InAudio.AudioTuple>();
...
//        {
//            AudioSources.Add(new InAudio.AudioTuple(source as HDRAudioSource));
//        }
...
//        InAudio.AudioTuple loudestSource;
...
//        if (ScaleInRelationTo == InAudio.ScalingType.EnviromentLoudness)
...
//    private float UpdateHDRLoudness(out InAudio.AudioTuple loudestSource)
//    {
